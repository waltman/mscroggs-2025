...
eq1 = lambda a, b, c: (a*b) + c == 11
eq2 = lambda a, b, c: (a/b) / c == 1
eq3 = lambda a, b, c: (a+b) - c == 1
eq4 = lambda a, b, c: (a*b) - c == 1
eq5 = lambda a, b, c: (a/b) - c == 0
eq6 = lambda a, b, c: (a+b) / c == 1
